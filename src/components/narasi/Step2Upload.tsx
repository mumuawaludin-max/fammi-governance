...
export function Step2Upload({ state, onChange, onNext, onBack, isParsing }: Step2UploadProps) {
    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-xs text-text-secondary mt-1">
          Workbook harus memiliki sheet <strong>Indikator Guru</strong> dan <strong>Rubrik Orangtua</strong>.
        ...
        {hasFile ? (
          <>
            ...
            <div className="text-center">
              ...
              {isParsing && (
                <p className="text-xs text-fammi mt-1 animate-pulse">Membaca workbook...</p>
              )}
            </div>
            <button
              type="button"
      ...
      <div className="flex items-start gap-3 bg-fammi-50 rounded-2xl p-4 border border-fammi-100">
        ...
        <div className="flex flex-col gap-1">
          ...
          <ul className="text-xs text-text-secondary space-y-0.5 list-disc list-inside">
            <li>Sheet <strong>Indikator Guru</strong> dengan kolom Karakter dan Indikator Pencapaian</li>
            <li>Sheet <strong>Rubrik Orangtua</strong> dengan kolom Karakter, Pertanyaan, dan opsi skor</li>
            <li>Kolom BGCOLOR dan TEXTCOLOR bersifat opsional</li>
          </ul>
        </div>
      </div>
